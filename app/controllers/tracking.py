...
def track_open(track_id=None):
    ...
    try:
        ...
        if existing:
            ...
            # Always update tracks with the LATEST opener's data.
            # Historical per-open data is preserved in open_events table.
            # Only email metadata uses COALESCE (preserve pre-registered info).
